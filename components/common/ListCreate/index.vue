	...
	<view class="list-create">
		...
		<main>
			<template v-if="listOptions.listData.length>0">
				<ul class="app-list-create  u-skeleton u-skeleton-circle u-skeleton-rect u-skeleton-fillet">
				...
				<u-loadmore margin-top="20" margin-bottom="20" :is-dot="true" :status="status" :icon-type="iconType" :load-text="loadText" />
			</template>
			<template v-else>
